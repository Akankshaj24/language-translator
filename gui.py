...
def translate_to_french(english_sentence):
    ...
    # french_sentence = french_tokenizer.sequences_to_texts([french_sentence])
...
# Heading for input
input_heading = tk.Label(input_frame, text="Enter the text to be translated from English", font=(font_style, font_size, 'bold'))
input_heading.pack()
